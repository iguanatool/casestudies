...
public class month_days extends TestObject {

    private static final CaseStudy CASE_STUDY = new CaseStudy("calendar");
    private static final String TEST_OBJECT_NAME = "month_days";
    private static final int TEST_OBJECT_ID = 2;
    ...
    protected InputSpecification instantiateInputSpecification() {
        return new org.iguanatool.casestudies.calendar.inputspecifications.month_days();
    }
